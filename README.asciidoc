...
The biggest choice with regards to the HA setup is whether you will use an external database, or you will go with the newer option of an embedded etcd cluster.
